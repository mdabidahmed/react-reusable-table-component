...
export const usePagination = (perPageRecords: any, totalRecords: any) => {
  ...
  return [totalPages, startPageIndex, endPageIndex, currentPage, displayPage];
};
